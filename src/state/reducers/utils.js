...
import {isNil, difference, flip, reject, all, identity} from 'ramda'

import type {Id, Sith, CacheSiths} from '../types'

// $FlowFixMe
export const isValid = (ids: Array<number | null>): boolean => all(identity)(ids)

export const removed = (before: Array<Id>, after: Array<Id>) => reject(isNil, difference(before, after))
export const added = flip(removed)
